...
Dear <?php echo $name != 'All' ? $name.' / Chinthaka Deshapriya' : $name; ?>,
<br/><br/>
Please find bellow item return details for your reference.
<br/><br/>
Issue Type : <strong><?php echo $item_receive->ItemIssue->ItemIssueType->name; ?></strong>
<br/>
<?php if($item_receive->remarks != ''){ ?>
Remarks : <strong><?php echo $item_receive->remarks; ?></strong>
<?php } ?>
<br/><br/>
