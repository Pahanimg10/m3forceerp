...
@section('title')
<title>M3Force | Credit Supplier Payment</title>
@endsection

@section('breadcrumb')
<ul class="breadcrumb">
    <li><a href="#">Payment</a></li>                    
    <li class="active">Credit Supplier Payment</li>
</ul>
@endsection
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <ul class="panel-controls">
                        ...
                        <li><div><a ng-show="data.id" target="_blank" class="btn btn-default" ng-href="<%=base_url%>/payment/print_credit_supplier_payment?id=<%=data.id%>">Print</a></div></li>
                        <li><a href="{{ asset('payment/credit_supplier_detail?id='.$credit_supplier_id)}}"><span class="fa fa-times"></span></a></li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="row">
                                    <h4 class="col-md-12" style="padding-top: 15px;">Supplier Details</h4>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="supplier_name" name="supplier_name" ng-model="supplier_name" class="form-control" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Supplier Address</label>
                                            <input type="text" id="supplier_address" name="supplier_address" ng-model="supplier_address" class="form-control" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="control-label">Supplier Contact No</label>
                                            <input type="text" id="supplier_contact_no" name="supplier_contact_no" ng-model="supplier_contact_no" class="form-control text-center" disabled />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="payment_no" name="payment_no" ng-model="data.payment_no" class="form-control text-center" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">Payment Date</label>
                                            <input type="text" id="payment_date" name="payment_date" uib-datepicker-popup="<%=dateFormat%>" ng-model="data.payment_date" is-open="paymentDatePopup.opened" datepicker-options="availableDateOptions" close-text="Close" ng-click="OpenPaymentDate()" class="form-control text-center" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">Payment Time</label>
                                            <input type="text" id="payment_time" name="payment_time" ng-model="data.payment_time" class="form-control text-center" />
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
            ...
            link: function (scope, element, attr) {
                element.validate({
                    ...
                    messages: {
                        ...
                        payment_time: {
                            required: 'Payment Time is required',
    ...
    myApp.controller('mainController', ['$scope', '$http', '$rootScope', 'uiGridConstants', 'uiGridExporterConstants', '$timeout', '$q', '$window', function ($scope, $http, $rootScope, uiGridConstants, uiGridExporterConstants, $timeout, $q, $window) {  
        ...
        $scope.paymentDatePopup = {
            opened: false
        };        
        $scope.OpenPaymentDate = function () {
            $scope.paymentDatePopup.opened = !$scope.paymentDatePopup.opened;
        };
        ...
        $http({
            ...
            $scope.data = {
                id: <?php echo $credit_supplier_payment_id ? $credit_supplier_payment_id : 0; ?>,
                credit_supplier_id: <?php echo $credit_supplier_id ? $credit_supplier_id : 0; ?>,
            ...
            $http({
                ...
                params: {
                    id: $scope.data.credit_supplier_id
                }
            }).then(function successCallback(response) {
                if(response.data.credit_supplier){
                    $scope.supplier_name = response.data.credit_supplier.contact ? response.data.credit_supplier.contact.name : '';
                    $scope.supplier_address = response.data.credit_supplier.contact ? response.data.credit_supplier.contact.address : '';
                    $scope.supplier_contact_no = response.data.credit_supplier.contact ? response.data.credit_supplier.contact.contact_no : '';
                }
        ...
        submitForm = function(){
            ...
            if($scope.data.id == 0){
                $http.post(base_url + '/payment', $scope.data).success(function (result) {
                    $('#save_button').prop('disabled', false);
                    $.pnotify && $.pnotify({
                        title: 'Credit Supplier Payments',
                        text: result.message,
                ...
                $http.put(base_url + '/payment/'+$scope.data.id, $scope.data).success(function (result) {
                    $('#save_button').prop('disabled', false);
                    $.pnotify && $.pnotify({
                        title: 'Credit Supplier Payments',
                        text: result.message,
        ...
        $scope.main_refresh = function(){
            ...
            $http({
                method: 'GET',
                url: base_url + '/payment/find_credit_supplier_payment',
                params: {
                    id: $scope.data.id
                }
            }).then(function successCallback(response) {
                if(response.data){
                    var payment_date_time = response.data.payment_date_time.split(' ');
                    $scope.data = {
                        id: response.data.id,
                        credit_supplier_id: response.data.credit_supplier_id,
                        ...
                        payment_date: payment_date_time[0],
                        payment_time: payment_date_time[1],
