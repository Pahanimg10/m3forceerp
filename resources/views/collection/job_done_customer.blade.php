...
@section('title')
<title>M3Force | Job Done Customer</title>
@endsection

@section('breadcrumb')
<ul class="breadcrumb">
    <li><a href="#">Collection</a></li>                    
    <li class="active">Job Done Customer</li>
</ul>
@endsection
        ...
        <form autocomplete="off" id="dataForm" name="dataForm" class="form-horizontal" j-validate>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Job Done Customer</strong></h3>
...
<script type="text/javascript">
    ...
    myApp.controller('mainController', ['$scope', '$http', '$rootScope', 'uiGridConstants', 'uiGridExporterConstants', '$timeout', '$q', '$window', function ($scope, $http, $rootScope, uiGridConstants, uiGridExporterConstants, $timeout, $q, $window) {  
        $scope.gridOptions = {
            columnDefs: [
                ...
                },
                {
                    ...
                    cellTemplate: '<div class="ui-grid-cell-contents"><a ng-href="'+base_url+'/job_done_customer/job_done_customer_detail?id=<%= row.entity.id %>"><%= row.entity.name %></a></div>'
                },
                {
                    field: 'address', 
                    displayName: 'Address', 
            ...
            exporterCsvFilename: 'Job Done Customers.csv',
        ...
        $scope.main_refresh = function(){
            ...
            $http({
                method: 'GET',
                url: base_url + '/job_done_customer/job_done_customer_list'
