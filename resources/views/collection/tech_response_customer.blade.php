...
@section('title')
<title>M3Force | Tech Response Customer</title>
@endsection

@section('breadcrumb')
<ul class="breadcrumb">
    <li><a href="#">Collection</a></li>                    
    <li class="active">Tech Response Customer</li>
</ul>
@endsection
        ...
        <form autocomplete="off" id="dataForm" name="dataForm" class="form-horizontal" j-validate>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Tech Response Customer</strong></h3>
...
<script type="text/javascript">
    ...
    myApp.controller('menuController', function ($scope) {
        ...
        angular.element(document.querySelector('#sub_menu_tech_response_quotation')).addClass('active');
    });  
    ...
    myApp.controller('mainController', ['$scope', '$http', '$rootScope', 'uiGridConstants', 'uiGridExporterConstants', '$timeout', '$q', '$window', function ($scope, $http, $rootScope, uiGridConstants, uiGridExporterConstants, $timeout, $q, $window) {  
        $scope.gridOptions = {
            columnDefs: [
                ...
                },
                {
                    ...
                    cellTemplate: '<div class="ui-grid-cell-contents"><a ng-href="'+base_url+'/tech_response_customer/tech_response_customer_detail?id=<%= row.entity.id %>"><%= row.entity.name %></a></div>'
                },
                {
                    field: 'address', 
                    displayName: 'Address', 
            ...
            exporterCsvFilename: 'Tech Response Customers.csv',
        ...
        $scope.main_refresh = function(){
            ...
            $http({
                method: 'GET',
                url: base_url + '/tech_response_customer/tech_response_customer_list'
                ...
                $.each(response.data, function (index, value) {
                    ...
                    data_array.push({
                        id: value.id,
                        name: value.contact ? value.contact.name : '',
                        address: value.contact ? value.contact.address : '',
                        contact_no: value.contact ? value.contact.contact_no : '',
                        email: value.contact ? value.contact.email : '',
