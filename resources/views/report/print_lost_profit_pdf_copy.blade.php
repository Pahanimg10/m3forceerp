        ...
        <table id="detail_table">
                    ...
                    foreach ($quotations as $quotation) {
                        ...
                        foreach ($quotation->QuotationDiscount as $detail) {
                            ...
                            if ($detail['discount_type_id'] == 1) {
                                $package_discount += $main_items_total * $percentage;
                            } else if ($detail['discount_type_id'] == 2) {
                                $special_discount += $equipment_installation_total * $percentage;
                            }
                        }
                    }
            ...
            <tfoot>
                <?php
                    ...
                    ?>
                <tr>
                    <th colspan="5" style="<?php echo $style; ?> text-align: center; vertical-align: middle;">Total</th>
                    <th style="<?php echo $style; ?> text-align: right; vertical-align: middle; white-space: nowrap;"><?php echo number_format($total_cost_value, 2); ?></th>
                    <th style="<?php echo $style; ?> text-align: right; vertical-align: middle; white-space: nowrap;"><?php echo number_format($total_quotation_value, 2); ?></th>
                    <th style="<?php echo $style; ?> text-align: right; vertical-align: middle; white-space: nowrap;"><?php echo number_format($total_lost_profit, 2); ?></th>
                    <th style="<?php echo $style; ?> text-align: right; vertical-align: middle; white-space: nowrap;"></th>
                    <th style="<?php echo $style; ?> text-align: right; vertical-align: middle; white-space: nowrap;"><?php echo number_format($total_actual_cost, 2); ?></th>
                    <th style="<?php echo $style; ?> text-align: right; vertical-align: middle; white-space: nowrap;"><?php echo number_format($total_budgeted_lost_profit, 2); ?></th>
                </tr>
                <?php
                    $s++;
                    $count++;
                    ...
                    ?>
                <tr>
                    <th colspan="11" style="<?php echo $style; ?> text-align: center; vertical-align: middle;"></th>
                </tr>
                <?php
                    $s++;
                    $count++;

                    $budgeted_profit_percentage = ($total_quotation_value - $total_cost_value) * 100 / $total_cost_value;
                ...
                <?php
                    ...
                    $actual_profit_percentage = ($total_quotation_value - $total_actual_cost) * 100 / $total_actual_cost;
