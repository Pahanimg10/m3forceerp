...
@section('title')
<title>M3Force | Print Item Return</title>
@endsection
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 style="margin-top: 5px; margin-bottom: 5px; float: right; font-family: Verdana, Geneva, sans-serif; font-size: 14px;">Item Return</h4>
    </div>
    <div class="panel-body">
        <table id="header_table">
            <tr>
                <?php
                    $customer = '';
                    $customer = $item_receive->ItemIssue && $item_receive->ItemIssue->item_issue_type_id == 1 ? $item_receive->ItemIssue->Job->Inquiry->Contact->name : $customer;
                    $customer = $item_receive->ItemIssue && $item_receive->ItemIssue->item_issue_type_id == 2 ? $item_receive->ItemIssue->TechResponse->Contact->name : $customer;
                ?>
                <td>Issued To</td>
                <td><?php echo $customer != '' ? $customer . ' : ' . $item_receive->ItemIssue->issued_to : $item_receive->ItemIssue->issued_to; ?></td>
                <td>Item Issue No</td>
                <td><?php echo $item_receive->ItemIssue->item_issue_no; ?></td>
            </tr>
            <tr>
                <td>Item Return No</td>
                <td><?php echo $item_receive->item_receive_no; ?></td>
                <td>Date & Time</td>
                <td><?php echo $item_receive->item_receive_date_time; ?></td>
            </tr>
            <tr>
                <td>Remarks</td>
                <td colspan="3"><?php echo $item_receive->remarks; ?></td>
            </tr>
        </table>
    </div>
</div>
...
<div class="panel panel-default" style="margin-top: 10px;">
    <div class="panel-body">
        <table id="item_detail_table">
                    ...
                    foreach ($item_receive->ItemReceiveDetails as $index => $value){
                        ...
                        foreach ($value->ItemReceiveBreakdown as $item_receive_breakdown){
                            if($item_receive_breakdown->type == 1){
                                ...
                                if(!in_array($item_receive_breakdown->GoodReceiveBreakdown->GoodReceiveDetails->id, $grn_detail_ids)){
                                    array_push($grn_detail_ids, $item_receive_breakdown->GoodReceiveBreakdown->GoodReceiveDetails->id);
                                }
                            } else{
                                $item_total += $item_receive_breakdown->GoodReceiveDetails->rate * $item_receive_breakdown->quantity;
                                if(!in_array($item_receive_breakdown->GoodReceiveDetails->id, $grn_detail_ids)){
                                    array_push($grn_detail_ids, $item_receive_breakdown->GoodReceiveDetails->id);
                                }
                            }
                        }
            ...
            <tfoot>
                <tr>
                    <th colspan="6" style="<?php echo $style; ?>">Total</th>
...
<div class="panel panel-default" style="margin-top: 50px;">
    <div class="panel-body">
        <table id="signature_table">
            ...
            <tr>
                <td style="width: 5%;"></td>
                <td style="width: 25%; text-align: center;">Good Returner</td>
                <td style="width: 40%;"></td>
