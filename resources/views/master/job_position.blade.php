...
@section('title')
<title>M3Force | Job Positions</title>
@endsection
        ...
        <form autocomplete="off" id="dataForm" name="dataForm" class="form-horizontal" j-validate>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Job Positions</strong></h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="name" name="name" placeholder="Operation Executive" ng-model="data.name" class="form-control" required="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="code" name="code" placeholder="OE" ng-model="data.code" class="form-control" required="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2"></div>
...
<script type="text/javascript">
    ...
    myApp.controller('menuController', function ($scope) {
        ...
        angular.element(document.querySelector('#sub_menu_job_positions')).addClass('active');
    });   
                ...
                element.validate({
                    rules: {
                        ...
                        code: {
                            required: true,
                            remote: {
                                url: base_url + '/job_position/validate_job_position',
                                type: 'GET',
                                data: {
                                    value: function() {
    ...
    myApp.controller('mainController', ['$scope', '$http', '$rootScope', 'uiGridConstants', 'uiGridExporterConstants', '$timeout', '$q', '$window', function ($scope, $http, $rootScope, uiGridConstants, uiGridExporterConstants, $timeout, $q, $window) {  
            ...
            $scope.gridOptions = {
                ...
                exporterCsvFilename: 'Job Positions.csv',
            ...
            $scope.editRecord = function (row) {
                ...
                $http({
                    method: 'GET',
                    url: base_url + '/job_position/find_job_position',
                    params: {
                        id: row.entity.id
                    }
            ...
            $scope.deleteRecord = function (row) {
                ...
                $http({
                    ...
                    swal({
                        title: "Are you sure?",
                        text: "You will not be able to recover <strong>" + response.data.name + "</strong> job position!",
                        html: true,
                        type: "warning",
                    ...
                    function(){
                        $http.delete(base_url + '/job_position/'+$scope.data.id, $scope.data).success(function (response_delete) {
                            swal({
                                title: "Deleted!", 
                                text: response.data.name + " job position has been deleted.", 
                                type: "success",
            ...
            submitForm = function(){
                ...
                if($scope.data.id == 0){
                    $http.post(base_url + '/job_position', $scope.data).success(function (result) {
                    ...
                    $http.put(base_url + '/job_position/'+$scope.data.id, $scope.data).success(function (result) {
                        $('#save_button').prop('disabled', false);
                        $.pnotify && $.pnotify({
                            title: 'Job Positions',
                            text: result.message,
            ...
            $scope.main_refresh = function(){
                ...
                $http({
                    method: 'GET',
                    url: base_url + '/job_position/job_position_list'
                }).then(function successCallback(response) {
                    var data_array = [];
                    $.each(response.data.job_positions, function (index, value) {
                        data_array.push({
                            id: value.id,
