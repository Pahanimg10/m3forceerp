...
@section('title')
<title>M3Force | C-Contact Types</title>
@endsection

@section('breadcrumb')
<ul class="breadcrumb">
    <li><a href="#">Master</a></li>                    
    <li class="active">C-Contact Types</li>
</ul>
@endsection
        ...
        <form autocomplete="off" id="dataForm" name="dataForm" class="form-horizontal" j-validate>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>C-Contact Types</strong></h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="name" name="name" placeholder="Customer" ng-model="data.name" class="form-control" required="" />
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    myApp.controller('menuController', function ($scope) {
        ...
        angular.element(document.querySelector('#sub_menu_c_contact_type')).addClass('active');
    });   
                ...
                element.validate({
                    rules: {
                        name: {
                            required: true,
                            remote: {
                                url: base_url + '/c_contact_type/validate_c_contact_type',
                                type: 'GET',
                                data: {
                                    value: function() {
    ...
    myApp.controller('mainController', ['$scope', '$http', '$rootScope', 'uiGridConstants', 'uiGridExporterConstants', '$timeout', '$q', '$window', function ($scope, $http, $rootScope, uiGridConstants, uiGridExporterConstants, $timeout, $q, $window) {  
            ...
            $scope.gridOptions = {
                ...
                exporterCsvFilename: 'C-Contact Types.csv',
            ...
            $scope.editRecord = function (row) {
                ...
                $http({
                    method: 'GET',
                    url: base_url + '/c_contact_type/find_c_contact_type',
                    params: {
                        id: row.entity.id
                    }
            ...
            $scope.deleteRecord = function (row) {
                ...
                $http({
                    ...
                    swal({
                        title: "Are you sure?",
                        text: "You will not be able to recover <strong>" + response.data.name + "</strong> c-contact type!",
                        html: true,
                        type: "warning",
                    ...
                    function(){
                        $http.delete(base_url + '/c_contact_type/'+$scope.data.id, $scope.data).success(function (response_delete) {
                            swal({
                                title: "Deleted!", 
                                text: response.data.name + " c-contact type has been deleted.", 
                                type: "success",
            ...
            submitForm = function(){
                ...
                if($scope.data.id == 0){
                    $http.post(base_url + '/c_contact_type', $scope.data).success(function (result) {
                        $('#save_button').prop('disabled', false);
                        $.pnotify && $.pnotify({
                            title: 'C-Contact Types',
                            text: result.message,
                    ...
                    $http.put(base_url + '/c_contact_type/'+$scope.data.id, $scope.data).success(function (result) {
                        $('#save_button').prop('disabled', false);
                        $.pnotify && $.pnotify({
                            title: 'C-Contact Types',
                            text: result.message,
            ...
            $scope.main_refresh = function(){
                ...
                $http({
                    method: 'GET',
                    url: base_url + '/c_contact_type/c_contact_type_list'
                }).then(function successCallback(response) {
                    var data_array = [];
                    $.each(response.data.c_contact_types, function (index, value) {
                        data_array.push({
                            id: value.id,
