...
@section('title')
<title>M3Force | Person Responsible</title>
@endsection

@section('breadcrumb')
<ul class="breadcrumb">
    <li><a href="#">Master</a></li>                    
    <li class="active">Person Responsible</li>
</ul>
@endsection
        ...
        <form autocomplete="off" id="dataForm" name="dataForm" class="form-horizontal" j-validate>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Person Responsible</strong></h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title" name="title" ng-model="data.title" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="head_name" name="head_name" ng-model="data.head_name" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">Head Contact No</label>             
                                            <input type="text" id="head_contact_no" name="head_contact_no" ng-model="data.head_contact_no" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="control-label">Head Email</label>             
                                            <input type="text" id="head_email" name="head_email" ng-model="data.head_email" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
...
<script type="text/javascript">
    ...
    myApp.controller('menuController', function ($scope) {
        ...
        angular.element(document.querySelector('#sub_menu_person_responsible')).addClass('active');
    });   
                ...
                element.validate({
                    rules: {
                        name: {
                            required: true,
                            remote: {
                                url: base_url + '/person_responsible/validate_person_responsible',
                                type: 'GET',
                                data: {
                                    value: function() {
    ...
    myApp.controller('mainController', ['$scope', '$http', '$rootScope', 'uiGridConstants', 'uiGridExporterConstants', '$timeout', '$q', '$window', function ($scope, $http, $rootScope, uiGridConstants, uiGridExporterConstants, $timeout, $q, $window) {  
            ...
            $scope.gridOptions = {
                ...
                exporterCsvFilename: 'Person Responsibles.csv',
            ...
            $scope.editRecord = function (row) {
                ...
                $http({
                    method: 'GET',
                    url: base_url + '/person_responsible/find_person_responsible',
                    params: {
                        id: row.entity.id
                    }
                    ...
                    $scope.data = {
                        ...
                        head_contact_no: response.data.head_contact_no,
                        head_email: response.data.head_email,
            ...
            $scope.deleteRecord = function (row) {
                ...
                $http({
                    ...
                    swal({
                        title: "Are you sure?",
                        text: "You will not be able to recover <strong>" + response.data.name + "</strong> person responsible!",
                        html: true,
                        type: "warning",
                    ...
                    function(){
                        $http.delete(base_url + '/person_responsible/'+$scope.data.id, $scope.data).success(function (response_delete) {
                            swal({
                                title: "Deleted!", 
                                text: response.data.name + " person responsible has been deleted.", 
                                type: "success",
            ...
            submitForm = function(){
                ...
                if($scope.data.id == 0){
                    $http.post(base_url + '/person_responsible', $scope.data).success(function (result) {
                        $('#save_button').prop('disabled', false);
                        $.pnotify && $.pnotify({
                            title: 'Person Responsibles',
                            text: result.message,
                    ...
                    $http.put(base_url + '/person_responsible/'+$scope.data.id, $scope.data).success(function (result) {
                        $('#save_button').prop('disabled', false);
                        $.pnotify && $.pnotify({
                            title: 'Person Responsibles',
                            text: result.message,
            ...
            $scope.main_refresh = function(){
                ...
                $http({
                    method: 'GET',
                    url: base_url + '/person_responsible/person_responsible_list'
                }).then(function successCallback(response) {
                    var data_array = [];
