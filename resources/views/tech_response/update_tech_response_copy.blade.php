                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="row" ng-show="data.update_status && data.update_status.id == 13 && data.is_chargeable">
                                    <div class="col-md-12">
        ...
        $scope.refreshForm = function(){
            $http({
                ...
                $.each(response.data.tech_response_status, function (index, value) {
                    ...
                    } else if(response.data.users_id == 1 || response.data.users_id == 24 || response.data.users_id == 37){
                        update_status_array.push({
                            id: value.id,
                            name: value.name
                        });
            ...
            $http({
                ...
                if(response.data){
                    ...
                    $scope.data = {
                        ...
                        update_status: response.data.tech_response_status ? {id:response.data.tech_response_status.id, name:response.data.tech_response_status.name} : {},
        ...
        $scope.deleteRecord = function (row) {
            ...
            $http({
                ...
                if(response.data){
                    ...
                    function(){
                        $http.delete(base_url + '/tech_response/'+$scope.data.id, {params: {type: $scope.data.type}}).success(function (response_delete) {
                            swal({
                                title: "Deleted!", 
            ...
            if($scope.data.update_status.id == 13){
                $http({
                    ...
                    if(response.data){
                        swal({
                            title: "Are you sure?",
                            text: "Tech Response value : <strong>" + parseFloat(Math.round(response.data.tech_response_value * 100) / 100).toFixed(2) + "</strong> !",
                            html: true,
                            type: "warning",
                            showCancelButton: true,
                            confirmButtonColor: "#FF0000",
