...
@section('title')
<title>M3Force | Print Tech Response Installation Sheet</title>
@endsection
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 style="margin-top: 5px; margin-bottom: 5px; float: right; font-family: Verdana, Geneva, sans-serif; font-size: 14px;">Tech Response Installation Sheet</h4>
    </div>
    <div class="panel-body">
        <table id="header_table">
            <tr>
                <td>Customer Name</td>
                <td>{{ $tech_response_installation_sheet->TechResponse->Contact->name }}</td>
                <td>Tech Response Installation Sheet No</td>
                <td>{{ $tech_response_installation_sheet->tech_response_installation_sheet_no }}</td>
            </tr>
            <tr>
                <td>Address</td>
                <td>{{ $tech_response_installation_sheet->TechResponse->Contact->address }}</td>
                <td>Date & Time</td>
                <td>{{ $tech_response_installation_sheet->tech_response_installation_sheet_date_time }}</td>
            </tr>
            <tr>
                <td>Email</td>
                <td>{{ $tech_response_installation_sheet->TechResponse->Contact->email }}</td>
                <td>Remarks</td>
                <td>{{ $tech_response_installation_sheet->remarks }}</td>
            </tr>
            <tr>
                <td>Contact No</td>
                <td>{{ $tech_response_installation_sheet->TechResponse->Contact->contact_no }}</td>
                <td></td>
                <td></td>
            </tr>
        </table>
...
<div class="panel panel-default" style="margin-top: 10px;">
    <div class="panel-body">
        <table id="detail_table">
            ...
            {{--*/ $total_quantity = 0 /*--}}
            {{--*/ $total_value = 0 /*--}}
            @if ($tech_response_installation_sheet->TechResponseInstallationSheetDetails)
                @foreach ($tech_response_installation_sheet->TechResponseInstallationSheetDetails as $index => $value)
