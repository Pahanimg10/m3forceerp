...
@section('title')
<title>M3Force | Print Tech Response Job Card</title>
@endsection
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 style="margin-top: 5px; margin-bottom: 5px; float: right; font-family: Verdana, Geneva, sans-serif; font-size: 14px;">Tech Response Job Card</h4>
    </div>
    <div class="panel-body">
        <table id="header_table">
            <tr>
                <td>Customer Name</td>
                <td>{{ $tech_response_job_card->TechResponse->Contact->name }}</td>
                <td>Tech Response Job Card No</td>
                <td>{{ $tech_response_job_card->tech_response_job_card_no }}</td>
            </tr>
            <tr>
                <td>Address</td>
                <td>{{ $tech_response_job_card->TechResponse->Contact->address }}</td>
                <td>Date & Time</td>
                <td>{{ $tech_response_job_card->tech_response_job_card_date_time }}</td>
            </tr>
            <tr>
                <td>Email</td>
                <td>{{ $tech_response_job_card->TechResponse->Contact->email }}</td>
                <td>Remarks</td>
                <td>{{ $tech_response_job_card->remarks }}</td>
            </tr>
            <tr>
                <td>Contact No</td>
                <td>{{ $tech_response_job_card->TechResponse->Contact->contact_no }}</td>
                <td></td>
                <td></td>
            </tr>
        </table>
...
<div class="panel panel-default" style="margin-top: 10px;">
    <div class="panel-body">
        <table id="detail_table">
            ...
            {{--*/ $total_quantity = 0 /*--}}
            {{--*/ $total_value = 0 /*--}}
            @if ($tech_response_job_card->TechResponseJobCardDetails)
                @foreach ($tech_response_job_card->TechResponseJobCardDetails as $index => $value)
