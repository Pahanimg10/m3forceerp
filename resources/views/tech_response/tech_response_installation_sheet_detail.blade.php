...
@section('title')
<title>M3Force | Tech Response Installation Sheet Details</title>
@endsection

@section('breadcrumb')
<ul class="breadcrumb">
    <li><a href="#">Tech Response</a></li>                    
    <li class="active">Tech Response Installation Sheet Details</li>
</ul>
@endsection
        ...
        <form autocomplete="off" id="dataForm" name="dataForm" class="form-horizontal" j-validate>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Tech Response Installation Sheet Details</strong></h3>
                    <ul class="panel-controls">
                        ...
                        <li><button type="button" ng-show="data.tech_response_installation_sheet_id && data.is_posted == 0" ng-disabled="edit_disable" ng-click="postForm()" class="btn btn-danger" id="post_button">Post</button></li>
                        <li><button type="button" ng-show="data.tech_response_installation_sheet_id && data.is_posted == 1" ng-disabled="permission || data.is_approved == 1" ng-click="authorizeData()" class="btn btn-danger" data-toggle="modal" data-target="#dataModal">Authorize</button></li>
                        ...
                        <li><div><a ng-show="data.tech_response_installation_sheet_id" target="_blank" class="btn btn-default" ng-href="<%=base_url%>/tech_response_installation_sheet/print_tech_response_installation_sheet?id=<%=data.tech_response_installation_sheet_id%>">Print</a></div></li>
                        ...
                        <li><a href="{{ asset('tech_response/tech_response_installation_sheet?id='.$tech_response_id.'&type='.$type)}}"><span class="fa fa-times"></span></a></li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <input type="hidden" id="tech_response_installation_sheet_id" name="tech_response_installation_sheet_id" ng-model="data.tech_response_installation_sheet_id" class="form-control" />
                                ...
                                <div class="row">
                                    <h4 class="col-md-12" style="padding-top: 15px;">Tech Response Installation Sheet Details</h4>
                                </div>
                                
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="control-label">Installation Sheet No</label>
                                            <input type="text" id="tech_response_installation_sheet_no" name="tech_response_installation_sheet_no" ng-model="data.tech_response_installation_sheet_no" class="form-control text-center" disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="control-label">Installation Sheet Date</label>
                                            <input type="text" id="tech_response_installation_sheet_date" name="tech_response_installation_sheet_date" uib-datepicker-popup="<%=dateFormat%>" ng-model="data.tech_response_installation_sheet_date" ng-disabled="edit_disable" is-open="installationSheetDatePopup.opened" datepicker-options="availableDateOptions" close-text="Close" ng-click="OpenInstallationSheetDate()" class="form-control text-center" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="control-label">Installation Sheet Time</label>
                                            <input type="text" id="tech_response_installation_sheet_time" name="tech_response_installation_sheet_time" ng-model="data.tech_response_installation_sheet_time" ng-disabled="edit_disable" class="form-control text-center" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
...
//                            });
    ...
    myApp.directive('jValidate', function () {
        return {
            link: function (scope, element, attr) {
                element.validate({
                    rules: {
                        tech_response_installation_sheet_date: {
                            required: true,
                            date: true
                        },
                        tech_response_installation_sheet_time: {
                            required: true,
                            minlength: 5,
                            validTime: true
                        },
                        ...
                        quantity: {
                            ...
                            remote: {
                                url: base_url + '/validate_tech_response_installation_quantity',
                                type: 'GET',
                                data: {
                                    id: function() {
                                    ...
                                    tech_response_installation_sheet_id: function() {
                                      return scope.data.tech_response_installation_sheet_id;
                                    },
                                    item_id: function() {
                    ...
                    messages: {
                        tech_response_installation_sheet_date: {
                            required: 'Tech Response Installation Sheet Date is required',
                            date: 'Invalid date format'
                        },
                        tech_response_installation_sheet_time: {
                            required: 'Tech Response Installation Sheet Time is required',
    ...
    myApp.controller('mainController', ['$scope', '$http', '$rootScope', 'uiGridConstants', 'uiGridExporterConstants', '$timeout', '$q', '$window', function ($scope, $http, $rootScope, uiGridConstants, uiGridExporterConstants, $timeout, $q, $window) {  
        ...
        $scope.data.tech_response_installation_sheet_id = <?php echo $tech_response_installation_sheet_id ? $tech_response_installation_sheet_id : 0; ?>;
        ...
        $scope.installationSheetDatePopup = {
            opened: false
        };        
        $scope.OpenInstallationSheetDate = function () {
            $scope.installationSheetDatePopup.opened = !$scope.installationSheetDatePopup.opened;
        };
        ...
        $('#tech_response_installation_sheet_time').mask('00:00');
        ...
        $scope.refreshForm = function(){
            $http({
                ...
                $scope.data = {
                    ...
                    tech_response_installation_sheet_id: $scope.data.tech_response_installation_sheet_id,
                    tech_response_installation_sheet_no: '',
                    tech_response_installation_sheet_date: new Date(),
                    tech_response_installation_sheet_time: hh+':'+mm,
                    remarks: '',
                    is_posted: 0,
                    is_approved: 0,
                ...
                $http({
                    method: 'GET',
                    url: base_url + '/tech_response_installation_sheet/find_tech_response_installation_sheet',
                    params: {
                        id: $scope.data.tech_response_installation_sheet_id
                    }
                }).then(function successCallback(response) {
                    if(response.data.tech_response_installation_sheet){
                        var tech_response_installation_sheet_date_time = response.data.tech_response_installation_sheet.tech_response_installation_sheet_date_time.split(' ');
                        $scope.data.tech_response_installation_sheet_id = response.data.tech_response_installation_sheet.id;
                        $scope.data.tech_response_installation_sheet_no = response.data.tech_response_installation_sheet.tech_response_installation_sheet_no;
                        $scope.data.tech_response_installation_sheet_date = tech_response_installation_sheet_date_time[0];
                        $scope.data.tech_response_installation_sheet_time = tech_response_installation_sheet_date_time[1];
                        $scope.data.remarks = response.data.tech_response_installation_sheet.remarks;
                        $scope.data.is_posted = response.data.tech_response_installation_sheet.is_posted;
                        $scope.data.is_approved = response.data.tech_response_installation_sheet.is_approved;
                        $scope.edit_disable = response.data.tech_response_installation_sheet.is_posted == 1 ? true : false;
                    }
        ...
        $scope.editRecord = function (row) {
            $http({
                method: 'GET',
                url: base_url + '/tech_response_installation_sheet/find_tech_response_installation_sheet_detail',
                params: {
                    id: row.entity.id
                }
            }).then(function successCallback(response) {
                if(response.data){
                    ...
                    $scope.data = {
                        type: 1,
                        id: response.data.id,
                        tech_response_id: response.data.tech_response_installation_sheet ? response.data.tech_response_installation_sheet.tech_response_id : 0,
                        tech_response_installation_sheet_id: response.data.tech_response_installation_sheet ? response.data.tech_response_installation_sheet.id : 0,
                        tech_response_installation_sheet_no: response.data.tech_response_installation_sheet ? response.data.tech_response_installation_sheet.tech_response_installation_sheet_no : '',
                        tech_response_installation_sheet_date: tech_response_installation_sheet_date_time[0],
                        tech_response_installation_sheet_time: tech_response_installation_sheet_date_time[1],
                        remarks: response.data.tech_response_installation_sheet ? response.data.tech_response_installation_sheet.remarks : '',
                        is_posted: response.data.tech_response_installation_sheet ? response.data.tech_response_installation_sheet.is_posted : 0,
                        is_approved: response.data.tech_response_installation_sheet ? response.data.tech_response_installation_sheet.is_approved : 0,
        ...
        $scope.deleteRecord = function (row) {
            $http({
                ...
                if(response.data){
                    ...
                    function(){
                        $http.delete(base_url + '/tech_response_installation_sheet/'+$scope.data.id, {params: {type: $scope.data.type}}).success(function (response_delete) {
                            swal({
                                title: "Deleted!", 
        ...
        $scope.resetForm = function(){
            $scope.data.tech_response_installation_sheet_id = '';
            $scope.refreshForm();
            $scope.main_refresh();
        ...
        $scope.postForm = function(){
            swal({
                title: "Are you sure?",
                text: "Tech Response Installation Sheet No : <strong>"+ $scope.data.tech_response_installation_sheet_no+"</strong>",
                html: true,
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#FF0000",
            ...
            function(){
                ...
                $http({
                    method: 'GET',
                    url: base_url + '/tech_response_installation_sheet/post_tech_response_installation_sheet',
                    params: {
                        id: $scope.data.tech_response_installation_sheet_id
                    }
                }).then(function successCallback(response) {
                    ...
                    swal({
                        title: "Posted!", 
                        text: "Tech Response Installation Sheet No : "+ $scope.data.tech_response_installation_sheet_no,
                        html: true,
                        type: "success",
                        confirmButtonColor: "#9ACD32"
                    });
        ...
        submitForm = function(){
            ...
            if($scope.data.id == 0){
                $http.post(base_url + '/tech_response_installation_sheet', $scope.data).success(function (result) {
                    $('#save_button').prop('disabled', false);
                    $.pnotify && $.pnotify({
                        title: 'Tech Response Installation Sheet Details',
                        text: result.message,
                    ...
                    $scope.data.tech_response_installation_sheet_id = result.response ? result.data : 0;
                    $scope.refreshForm();
                    $scope.main_refresh();
                });
            } else{
                $http.put(base_url + '/tech_response_installation_sheet/'+$scope.data.id, $scope.data).success(function (result) {
                    $('#save_button').prop('disabled', false);
                    $.pnotify && $.pnotify({
                        title: 'Tech Response Installation Sheet Details',
                        text: result.message,
        ...
        $scope.main_refresh = function(){
            ...
            $scope.gridOptions.exporterCsvFilename = $scope.customer_name+' Tech Response Installation Sheet Details.csv';
            $http({
                method: 'GET',
                url: base_url + '/tech_response_installation_sheet/tech_response_installation_sheet_detail_list',
                params: {
                    id: $scope.data.tech_response_installation_sheet_id
                }
            }).then(function successCallback(response) {
                var data_array = [];
                $.each(response.data.tech_response_installation_sheet_details, function (index, value) {
                    data_array.push({
                        id: value.id,
                        permission: response.data.permission ? 1 : 0,
                        is_posted: value.tech_response_installation_sheet ? value.tech_response_installation_sheet.is_posted : 0,
