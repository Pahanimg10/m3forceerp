...
<div class="panel panel-default" style="margin-top: 20px;">
    <div class="panel-heading">
        <h4 style="margin-top: 5px; margin-bottom: 50px; float: left; font-family: Verdana, Geneva, sans-serif; font-size: 14px;">Certified By</h4>
    </div>
    <div class="panel-body">
        <table id="signature_table">
            <tr>
                ...
                <td style="border-bottom: 1px dotted black; width: 12.5%; text-align: center;"></td>
                <td style="width: 20%;"></td>
                <td style="border-bottom: 1px dotted black; width: 12.5%; text-align: center;"></td>
                <td style="width: 5%;"></td>
            </tr>
            <tr>
                ...
                <td style="width: 20%;"></td>
                <td style="width: 12.5%; text-align: center;">Signature</td>
                <td style="width: 20%;"></td>
                <td style="width: 12.5%; text-align: center;">Date</td>
                <td style="width: 5%;"></td>
            </tr>
        </table>       
    </div> 
