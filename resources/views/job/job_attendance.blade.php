...
@section('title')
<title>M3Force | Job Attendance</title>
@endsection

@section('breadcrumb')
<ul class="breadcrumb">
    <li><a href="#">Job</a></li>                    
    <li class="active">Job Attendance</li>
</ul>
@endsection
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <ul class="panel-controls">
                        ...
                        <li><div><a target="_blank" class="btn btn-info" ng-href="<%=base_url%>/job_attendance/print_work_sheet">Print Installation Work Sheet</a></div></li>
                        <li><div><a target="_blank" class="btn btn-danger" ng-href="<%=base_url%>/job_attendance/print_tech_work_sheet">Print Tech Response Work Sheet</a></div></li>
...
<script type="text/javascript">
    ...
    myApp.controller('mainController', ['$scope', '$http', '$rootScope', 'uiGridConstants', 'uiGridExporterConstants', '$timeout', '$q', '$window', function ($scope, $http, $rootScope, uiGridConstants, uiGridExporterConstants, $timeout, $q, $window) {  
        ...
        $scope.main_refresh = function(){
            ...
            $scope.gridOptions.exporterCsvFilename = 'Job Attendances From ' + $scope.data.from + ' To ' + $scope.data.to + '.csv';
            $http({
                method: 'GET',
                url: base_url + '/job_attendance/job_attendance_list',
                params: {
                ...
                $.each(response.data, function (index, value) {
                    data_array.push({
                        technical_team: value.technical_team,
        ...
        $scope.add_new = function () {
            $window.location.href = base_url + '/job_attendance/add_new';
        };
    }]);
</script>
@endsection