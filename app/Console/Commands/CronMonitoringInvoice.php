...
class CronMonitoringInvoice extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cron:monitoringInvoice';
     ...
     * @var string
     */
    protected $description = 'This command will generate monitoring invoice monthly';
                ...
                if ($monitoring_customer_invoice->MonitoringCustomer->is_group == 0) {
                    foreach ($monitoring_customer_invoice->MonitoringCustomer->Contact->ContactTax as $detail) {
                        if ($detail['CTaxType']) {
                            ...
                            } elseif ($detail['CTaxType']['id'] == 3) {
                                $invoice_value += $invoice_value * $detail['CTaxType']['percentage'] / 100;
                            }
                        }
                    }
                } elseif ($monitoring_customer_invoice->MonitoringCustomer->is_group == 1) {
