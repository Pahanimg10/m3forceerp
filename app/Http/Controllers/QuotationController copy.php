...
class QuotationController extends Controller
{
    ...
    {
        $valid = true;
        $job_card_exist = $cost_sheet_exist = false;
        ...
        foreach ($job_card_details as $job_card_detail) {
            $job_card_exist = true;
            $item_margin = $job_card_detail->Item && ($job_card_detail->Item->main_category_id == 2 || $job_card_detail->Item->main_category_id == 12 || $job_card_detail->Item->main_category_id == 14) ? 10 : 30;
        ...
        if ($job_card_exist && $cost_sheet_exist && floor($equipment_installation_total) - floor($request->quotation_value) > 0) {
            $valid = false;
        }
