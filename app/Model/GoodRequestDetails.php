...
class GoodRequestDetails extends Model
{
    ...
    {
        return $this->belongsTo(\App\Model\JobCardDetails::class, 'detail_id', 'id');
    }

    public function InstallationSheetDetails()
    {
        return $this->belongsTo(\App\Model\InstallationSheetDetails::class, 'detail_id', 'id');
    }

    public function TechResponseJobCardDetails()
    {
        return $this->belongsTo(\App\Model\TechResponseJobCardDetails::class, 'detail_id', 'id');
    }

    public function TechResponseInstallationSheetDetails()
    {
        return $this->belongsTo(\App\Model\TechResponseInstallationSheetDetails::class, 'detail_id', 'id');
    }
}
